...
function connectErrorFromH2ResetCode(rstCode) {
    switch (rstCode) {
        ...
        case H2Code.CONNECT_ERROR:
            return new connect_1.ConnectError(`http/2 stream closed with RST code ${H2Code[rstCode]} (0x${rstCode.toString(16)})`, connect_1.Code.Internal);
        case H2Code.REFUSED_STREAM:
            return new connect_1.ConnectError(`http/2 stream closed with RST code ${H2Code[rstCode]} (0x${rstCode.toString(16)})`, connect_1.Code.Unavailable);
        case H2Code.CANCEL:
            return new connect_1.ConnectError(`http/2 stream closed with RST code ${H2Code[rstCode]} (0x${rstCode.toString(16)})`, connect_1.Code.Canceled);
        case H2Code.ENHANCE_YOUR_CALM:
            return new connect_1.ConnectError(`http/2 stream closed with RST code ${H2Code[rstCode]} (0x${rstCode.toString(16)})`, connect_1.Code.ResourceExhausted);
        case H2Code.INADEQUATE_SECURITY:
            return new connect_1.ConnectError(`http/2 stream closed with RST code ${H2Code[rstCode]} (0x${rstCode.toString(16)})`, connect_1.Code.PermissionDenied);
...
})(H2Code = exports.H2Code || (exports.H2Code = {}));
