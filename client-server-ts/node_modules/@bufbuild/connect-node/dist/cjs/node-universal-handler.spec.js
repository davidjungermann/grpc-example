    ...
    describe("with HTTP/2 stream closed with an RST code", function () {
        ...
        const server = (0, use_node_server_helper_spec_js_1.useNodeServer)(() => {
            ...
            return http2.createServer(function (request) {
                universalRequestSignal = (0, node_universal_handler_js_1.universalRequestFromNodeRequest)(request, undefined).signal;
            });
        });
        ...
        it("should abort request signal with ConnectError and Code.Canceled for CANCEL", async function () {
            ...
            expect(universalRequestSignal).toBeInstanceOf(AbortSignal);
            expect(universalRequestSignal === null || universalRequestSignal === void 0 ? void 0 : universalRequestSignal.aborted).toBeTrue();
            expect(universalRequestSignal === null || universalRequestSignal === void 0 ? void 0 : universalRequestSignal.reason).toBeInstanceOf(connect_1.ConnectError);
            const ce = connect_1.ConnectError.from(universalRequestSignal === null || universalRequestSignal === void 0 ? void 0 : universalRequestSignal.reason);
    ...
    describe("with HTTP/1.1 ECONNRESET", function () {
        ...
        const server = (0, use_node_server_helper_spec_js_1.useNodeServer)(() => {
            const s = http.createServer({
                ...
                const uReq = (0, node_universal_handler_js_1.universalRequestFromNodeRequest)(request, undefined);
        ...
        it("should abort request signal with ConnectError and Code.Aborted", async function () {
            ...
            if (serverAbortReason instanceof Error) {
                expect(serverAbortReason).toBeInstanceOf(connect_1.ConnectError);
                const ce = connect_1.ConnectError.from(serverAbortReason);
