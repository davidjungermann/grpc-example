        ...
        describe("over http/2", function () {
            ...
            it("should reject the response promise with Code.Canceled", async function () {
                ...
                try {
                    ...
                    expect(connect_1.ConnectError.from(e).message).toBe("[canceled] http/2 stream closed with RST code CANCEL (0x8)");
                }
        ...
        describe("over http/2", function () {
            ...
            const server = (0, use_node_server_helper_spec_js_1.useNodeServer)(() => http2.createServer((req, res) => {
                void (async () => {
                    var _a, e_3, _b, _c;
                    try {
                        for (var _d = true, req_1 = __asyncValues(req), req_1_1; req_1_1 = await req_1.next(), _a = req_1_1.done, !_a;) {
                            _c = req_1_1.value;
                            _d = false;
                            try {
                                const chunk = _c;
        ...
        describe("over http/1.1", function () {
            ...
            const server = (0, use_node_server_helper_spec_js_1.useNodeServer)(() => http.createServer((req, res) => {
                void (async () => {
                    var _a, e_4, _b, _c;
                    try {
                        for (var _d = true, req_2 = __asyncValues(req), req_2_1; req_2_1 = await req_2.next(), _a = req_2_1.done, !_a;) {
                            _c = req_2_1.value;
                            _d = false;
                            try {
                                const chunk = _c;
        ...
        describe("over http/2", function () {
            ...
            const server = (0, use_node_server_helper_spec_js_1.useNodeServer)(() => http2.createServer((req, res) => {
                ...
                void (async () => {
                    var _a, e_7, _b, _c;
                    try {
                        for (var _d = true, req_3 = __asyncValues(req), req_3_1; req_3_1 = await req_3.next(), _a = req_3_1.done, !_a;) {
                            _c = req_3_1.value;
                            _d = false;
                            try {
                                const chunk = _c;
        ...
        describe("over http/1.1", function () {
            ...
            const server = (0, use_node_server_helper_spec_js_1.useNodeServer)(() => http.createServer((req, res) => {
                ...
                void (async () => {
                    ...
                    try {
                        try {
                            for (var _d = true, req_4 = __asyncValues(req), req_4_1; req_4_1 = await req_4.next(), _a = req_4_1.done, !_a;) {
                                _c = req_4_1.value;
                                _d = false;
                                try {
                                    const chunk = _c;
        ...
        describe("over http/2", function () {
            ...
            const server = (0, use_node_server_helper_spec_js_1.useNodeServer)(() => http2.createServer((req, res) => {
                ...
                void (async () => {
                    var _a, e_9, _b, _c;
                    try {
                        for (var _d = true, req_5 = __asyncValues(req), req_5_1; req_5_1 = await req_5.next(), _a = req_5_1.done, !_a;) {
                            _c = req_5_1.value;
                            _d = false;
                            try {
                                const chunk = _c;
        ...
        describe("over http/1.1", function () {
            ...
            const server = (0, use_node_server_helper_spec_js_1.useNodeServer)(() => http.createServer((req, res) => {
                ...
                void (async () => {
                    ...
                    try {
                        try {
                            for (var _d = true, req_6 = __asyncValues(req), req_6_1; req_6_1 = await req_6.next(), _a = req_6_1.done, !_a;) {
                                _c = req_6_1.value;
                                _d = false;
                                try {
                                    const chunk = _c;
